...
import { Download, PieChart, BarChart, FileText, Building2, Filter, ChevronLeft, ChevronRight, CheckSquare, Square, ChevronDown, Receipt, DollarSign } from 'lucide-react';
...
export const Reports: React.FC<ReportsProps> = ({ entries, projects, settings, clients }) => {
  ...
  const processedData = useMemo(() => {
    ...
    const monthlyData = months.map(monthDate => {
      ...
      const totalAmount = monthEntries.reduce((acc, entry) => {
  ...
  }, [entries, projects, clients, selectedYear, availableProjects, selectedProjectIds, invoiceFilter]);
